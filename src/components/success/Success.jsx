         ...
         <h1 className='text-4xl text-center pt-[50px] font-bold uppercase'>Thank You</h1>
            <div className='pt-20 p-2'>
                ...
                <div className='flex justify-center m-10 gap-3 py-5'>
                    <Link className='inline-block text-sm px-4 py-2 leading-none border rounded text-black border-black   bg-white hover:bg-black hover:text-white mt-4 lg:mt-0'>Booked Cards</Link>
